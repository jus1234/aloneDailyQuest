...
final class CoreDataManager {
    ...
    func saveQuestData(questText: String?, sunday: Bool, monday: Bool, tuesday: Bool, wednesday: Bool, thursday: Bool, friday: Bool, saturday: Bool, completion: @escaping () -> Void) {
        // 임시저장소에 있는지 확인
        if let context = context {
            ...
            if let entity = NSEntityDescription.entity(forEntityName: self.modelName, in: context) {
                ...
                if let questData = NSManagedObject(entity: entity, insertInto: context) as? QuestData {
                    ...
                    questData.sunday = sunday
                    questData.monday = monday
                    questData.tuesday = tuesday
                    questData.wednesday = wednesday
                    questData.thursday = thursday
                    questData.friday = friday
                    questData.saturday = saturday
